...
Questo progetto include un programma pensato per copiare a scuola durante le verifiche di laboratorio.<br>
Per non dare sospetti, si spaccia come CCleaner.



## File disponibili
- Il file .exe compilato: Può essere eseguito subito senza alcuna configurazione.<br>
...
## Funzionalità
- Up - Chiude completamente lo script<br>
- Right Ctrl - Sospende o riattiva lo script<br>
- Right Shift - Apre una nuova finestra di ChatGPT in background usando Google Chrome<br>
- Down - Chiude tutte le finestre di ChatGPT aperte in background<br>
- Right - Cambia finestra simulando la pressione di Alt + Esc<br>
- Left - Mostra il desktop simulando la pressione di Win + D<br>
